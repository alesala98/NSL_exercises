...
echo "Script to run the Ising simulation as a function of T"       #Note: probably you need to make this script executable using the command 'chmod +x name_script'
