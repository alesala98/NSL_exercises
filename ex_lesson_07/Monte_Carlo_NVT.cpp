...
int main(){ 
  ...
  cout << endl << "Equilibration of the system..." << endl ; 		//Equilibration choosing n_steps_equilibration = 1000
...
void Averages(int iblk){ 	//Print results for current block
   ...
   Epot << " " << iblk << " " << stima_pot << " " << glob_av[iv]/(double)iblk << " " << err_pot << endl;		//Potential energy per particle
   Pres << " " << iblk << " " << stima_pres << " " << glob_av[iw]/(double)iblk << " " << err_press << endl;		//Pressure
